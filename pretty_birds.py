...
def process_frame(frame):
    ...
    #cv2.rectangle(small_frame, (60,100), (134, 280), (255,255,0), 1)
    #cv2.rectangle(small_frame, (186,100), (260, 280), (255,255,0), 1)
...
while(True):
    ...
    if now - prev_time > Config.interval_in_milliseconds:
        ...
        pixels_with_motion_count_1, pixel_count_1 = measure_motion(
